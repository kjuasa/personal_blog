 ...
 <div class="container mt-5">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <?php echo form_open_multipart('posts/update'); ?><br>
        <input type="hidden" name="id" value="<?php echo $post['id']; ?>">
          ...
          <div class="form-group">
            <label>Body</label>
            <textarea name="body" id="editor1" placeholder="Enter post content" class="form-control" rows="8" cols="80"><?php echo $post['body']; ?></textarea>
          </div>
          <div class="form-group">
